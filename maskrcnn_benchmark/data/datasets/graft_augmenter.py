...
from pandas import DataFrame # NOTE: need to install
...
#         build
        ...
        self.transforms = deepcopy(dataset.transforms)
        ...
        result = get_dataset_statistics(cfg, train_data=dataset, return_lookup=True)
